...
class LoadCenario extends StatefulWidget {
  String idmodojogo;
  LoadCenario({Key key, this.idmodojogo}) : super(key: key);

  @override
  // ignore: no_logic_in_create_state
  State<LoadCenario> createState() => _LoadCenarioState(idmodojogo: idmodojogo);
}

class _LoadCenarioState extends State<LoadCenario> {
  String idmodojogo;
  _LoadCenarioState({this.idmodojogo});
