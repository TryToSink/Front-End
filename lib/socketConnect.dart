    ...
    d.forEach((key, value) {
      if(d != 'message') {
        if (d.containsKey('status') == false) {
          ...
          jogadaFimDados.jogo.partida.vencedor.elo = d['perdedor']['jogo']['partida']['vencedor']['elo'];
          ...
          jogadaFimDados.jogo.adversario.jogador.elo = d['perdedor']['jogo']['adversario']['jogador']['elo'];
